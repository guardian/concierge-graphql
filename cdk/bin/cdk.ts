...
new ConciergeGraphql(app, "ConciergeGraphql-PROD-AARDVARK", { stack: "content-api-preview", stage: "PROD-AARDVARK" });
new ConciergeGraphql(app, "ConciergeGraphql-CODE-AARDVARK", { stack: "content-api", stage: "CODE-AARDVARK" });
new ConciergeGraphql(app, "ConciergeGraphql-CODE-AARDVARK", { stack: "content-api-preview", stage: "CODE-AARDVARK" });

new ConciergeGraphql(app, "ConciergeGraphql-PROD-ZEBRA", { stack: "content-api", stage: "PROD-ZEBRA" });
new ConciergeGraphql(app, "ConciergeGraphql-PROD-ZEBRA", { stack: "content-api-preview", stage: "PROD-ZEBRA" });
new ConciergeGraphql(app, "ConciergeGraphql-CODE-ZEBRA", { stack: "content-api", stage: "CODE-ZEBRA" });
new ConciergeGraphql(app, "ConciergeGraphql-CODE-ZEBRA", { stack: "content-api-preview", stage: "CODE-ZEBRA" });